...
% The training data
[rownum,colnum]=size(XTrain);
XTrain = [XTrain ones(rownum,1)];

% The test data
[rownum,colnum]=size(XTest);
XTest = [XTest ones(rownum,1)];
...
learningRate  = 0.000001; % Change this, your learning rate
[~,colnum_X]=size(XTrain);
[~,colnum_D]=size(DTrain);
W0 = normrnd(0,1, colnum_X, colnum_D); % Change this, initialize your weight matrix W
